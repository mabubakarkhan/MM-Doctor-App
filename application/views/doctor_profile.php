                    ...
                    <div class="right-column mobile">
                        <div class="info-box">
                            <div class="clini-infos">
                                <h2>Hospital Name (Lahore)</h2>
                                <ul>
                                    <li><span>Fee</span><strong>2000</strong></li>
                                    <li><span>Address</span><strong><i class="feather-map-pin"></i> 23-A Faisal Town, Lahore</strong></li>
                                                                        
                                    <li><span class="avaliable">Available today</span><strong class="slide-btn">01:00 PM - 04:00 PM <i class="feather-chevron-down"></i></strong>
                                        <div class="Slide">
                                            <ul class="time-list">
                                                <li>
                                                    <span class="day">Monday</span>
                                                    <span class="time">01:00 PM - 04:00 PM</span>
                                                </li>
                                                <li>
                        ...
                        <div class="card-body">
                            <nav class="dr-nav">
                                <ul class="nav">
                                    ...
                                    <li><a href="#awards">Other Info</a></li>
                            ...
                            <div class="tab-content pt-0">
                                <div role="tabpanel" id="doc_overview" class="tab-pane fade show active">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-lg-12" id="awards">
                                             <?php if ($awards): ?>
