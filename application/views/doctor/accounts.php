                                ...
                                <div class="card flex-fill">
                                    <div class="card-header acc-title">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-6">
                                                <div class="text-end">
                                                    <a title="Edit Profile" class="btn bg-info-light btn-sm"
                                    ...
                                    <div class="card-body">
                                        <div class="profile-view-bottom">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="info-list">
                                                        <div class="text" id="bank_name"><?=$userSession['bank_name']?></div>
                                                        <div class="text" id="branch_name"><?=$userSession['bank_branch_code']?></div>
                                                        <div class="text" id="account_no"><?=$userSession['bank_account_number']?></div>
                                                        <div class="text mb-0" id="account_name"><?=$userSession['bank_account_title']?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6 d-flex">
                                <div class="card flex-fill">
                                    <ul class="account-list">
                                        <li>
                                            <h4>Earned <span class="text-success"><?=number_format($userSession['earned'])?></span></h4>
                                        </li>
                                        <li>
                                            <h4>Balance <span class="text-info"><?=number_format($userSession['balance'])?></span></h4>
                                        </li>
                                        <li>
                                            <h4>PayAble <span class="text-danger">$<?=number_format($userSession['payable'])?></span></h4>
                                        </li>
                                    </ul>
                                </div>
                            </div>
