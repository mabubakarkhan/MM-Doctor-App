                            ...
                            <div class="doc-info-left">
                                <div class="doctor-img1">
                                    <a href="pharmacy-details">
                                        <img src="<?=IMG?>medical-img1.jpg" class="img-fluid" alt="User Image">
                                    </a>
                                </div>
                                <div class="doc-info-cont">
                                    ...
                                    <div class="clinic-details">
                                        <div class="clini-infos pt-3">
                                            <p class="doc-location mb-2"><i class="feather-phone me-1"></i> 320-795-8815</p>
                                            <p class="doc-location mb-2 text-ellipse"><i class="feather-map-pin me-1"></i> 96 Red Hawk Road Cyrus, MN 56323 </p>
                                            <p class="doc-location mb-2"><i class="feather-chevrons-right me-1"></i> Chemists, Surgical Equipment Dealer</p>
                                            <p class="doc-location mb-2"><i class="feather-chevrons-right me-1"></i> Opens at 08.00 AM</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
