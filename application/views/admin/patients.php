                        ...
                        if (count($patients) > 0) {
                            foreach ($patients as $q): ?>
                                <tr>
                                    ...
                                    <td><?=$q['phone']?></td>
                                    <td class="actions">
                                        <a href="javascript://" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row get-patient" data-id="<?=$q['patient_id']?>"><i class="icon md-eye" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach;
                        } //end if
                            ...
                            <tr>
                                <td>
                                    No Patient found in the database
                                </td>
                                <td></td>
                                <td></td>
                                <td></td>
